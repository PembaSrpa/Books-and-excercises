...
### Reflection
Step 10 is where you learn to write **performant** code. In Step 7 of your Roadmap (GenAI for Data Analytics), you'll see that LLMs and complex algorithms rely on these exact memoization and hash-table principles to process vast amounts of data in real-time.

**Next Step:** Would you like to see how to use the `timeit` module to measure the exact speed difference between your standard and memoized functions?
