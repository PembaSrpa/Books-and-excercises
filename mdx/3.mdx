...
### Reflection
Interface design isn't just about drawing; it's about **architecture**. In Step 4 of the Roadmap (Python for Data Analysis), I will use these same principles to write functions that clean and process datasets automatically.
